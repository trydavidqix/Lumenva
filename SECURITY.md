...
Use o [relato privado de vulnerabilidades do GitHub](https://github.com/trydavidqix/Lumenva/security/advisories/new) — o relato chega só aos mantenedores, e o histórico fica auditável.
