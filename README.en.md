...
# 🛠️ Lumenva — The open-source AI Sales OS for WhatsApp
...
>
> Lumenva is developed in **partnership with HostGator**: the [`hostgator-setup-kit/`](hostgator-setup-kit/)
...
**Lumenva** is your entire sales operation on a single desk, run by people and AI agents working together.
...
- **Public MCP** — CRM capabilities exposed to the agent ecosystem: plug in any agent and it operates Lumenva.
...
- The community that took Lumenva from e-commerce to clinics, real estate, info-products and beyond — you defined what this project is.
