...
const result = await runValidationSuite({ root, binary, dataset, model: process.env.MCG_EVAL_MODEL || 'gpt-5.5', effort: process.env.MCG_EVAL_EFFORT || 'medium', limit: mode === 'smoke' ? 6 : null });
