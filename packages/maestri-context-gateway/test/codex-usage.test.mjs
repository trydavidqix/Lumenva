...
assert.deepEqual(usage, { input_tokens: 81011, cached_input_tokens: 60672, context_tokens: 141683, output_tokens: 464, reasoning_tokens: 216, total_tokens: 81691, measurement_type: 'exact', source: 'codex.exec.jsonl' });
