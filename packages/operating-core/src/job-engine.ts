...
export class JobEngineError extends Error { constructor(readonly code: "not_found" | "invalid_transition" | "tenant_mismatch" | "ownership_mismatch", message: string) { super(message); this.name = "JobEngineError"; } }
