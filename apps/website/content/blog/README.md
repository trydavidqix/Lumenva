...
3. Executar `pnpm typecheck`, `pnpm test` e `pnpm test:e2e` em `apps/website/`.
...
`apps/website/tests/e2e/blog.spec.ts` cobre homepage, categorias, busca, artigo, breadcrumb/JSON-LD, RSS, landmarks acessíveis e viewport mobile.
