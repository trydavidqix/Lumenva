...
const migration = readFileSync("infra/supabase/migrations/20260814082914_content_os_foundation.sql", "utf8");
const baseline = readFileSync("infra/supabase/baseline.sql", "utf8");
