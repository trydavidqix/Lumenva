...
beforeAll(() => {
  ...
  psql(readFileSync("infra/supabase/migrations/20260725010000_0071_crm_lead_activities_barramento.sql", "utf8"));
  ...
  psql(readFileSync("infra/supabase/migrations/20260725020000_0072_activity_evidence_llm_call_ids.sql", "utf8"));
});
