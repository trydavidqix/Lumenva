...
export type RerouteRequest = Readonly<{ requesterId: string; permissionLevel: "P0" | "P1" | "P2" | "P3" | "P4"; capabilities: readonly string[] }>;
export type RerouteResult = Readonly<{ signal: WatchdogSignal; decision: "ALLOW" | "DENY"; reason: "AUTHORIZED" | "INSUFFICIENT_PERMISSION" | "MISSING_CAPABILITY" | "P4_REQUIRES_APPROVAL"; processAction: "CONTINUE" }>;
