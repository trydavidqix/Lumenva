...
describe("Wave 4 BrowserMesh replay claims against real Postgres RLS", () => {
  ...
  beforeAll(async () => {
    ...
    await admin.query(readFileSync("infra/supabase/migrations/20260913100000_browsermesh_event_idempotency.sql", "utf8"));
    await admin.query(readFileSync("infra/supabase/migrations/20260913160000_0172_browsermesh_event_idempotency_rls.sql", "utf8"));
