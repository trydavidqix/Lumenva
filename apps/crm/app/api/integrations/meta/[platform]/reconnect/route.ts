...
export async function POST(
  ...
  try {
    ...
    if (platform !== 'facebook' && platform !== 'instagram') {
      return NextResponse.redirect(new URL('/app/content-os/accounts?error=invalid_platform', request.url))
    }
    ...
    return NextResponse.redirect(new URL('/app/content-os/accounts?error=reconnect_failed', request.url))
  }
}
