...
export async function POST(request: NextRequest): Promise<Response> {
  ...
  try {
    ...
    void audit({ action: "content.asset_registered", actorUserId: authz.user.id, organizationId: authz.org.orgId, resourceType: "content_asset", resourceId: asset.id, requestId, metadata: { asset_type: asset.asset_type, mime_type: asset.mime_type, has_license: Boolean(asset.license), has_provenance: Boolean(asset.provenance) } });
