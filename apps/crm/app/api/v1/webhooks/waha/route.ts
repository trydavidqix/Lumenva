...
export async function POST(req: NextRequest): Promise<NextResponse> {
  ...
  // nada em execução. O estágio 1 confere só o que a rota precisa ANTES de
  // arquivar: a sessão (resolve o tenant) e o id (coluna do arquivo). O
  // contrato completo vem depois do INSERT em webhook_events_log. Ver
