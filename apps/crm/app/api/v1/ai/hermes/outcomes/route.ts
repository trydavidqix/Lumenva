...
export async function GET(req: NextRequest): Promise<Response> {
  ...
  let query = db
    ...
    .select('id, run_id, mission_id, candidate_id, subject_kind, subject_id, technical_quality, cost_cents, latency_ms, kpi_name, kpi_baseline, kpi_observed, evidence_refs, observed_at, created_at')
  ...
  if (error) return fail('internal_error', 'Falha ao carregar outcomes Hermes.', 500, { requestId });
