...
describe("Postgres Consent Registry (real RLS)", () => {
  beforeAll(async () => {
    ...
    await admin.query("INSERT INTO public.organizations (id) VALUES ($1::uuid), ($2::uuid)", [ORG_A, ORG_B]);
    ...
    await admin.query(readFileSync("supabase/migrations/20260917100600_0191_contact_consents.sql", "utf8"));
  });
