...
-- Wave 11 durable Consent Registry (migration 20260913110000).
...
create index if not exists contact_consents_lookup_idx on public.contact_consents (organization_id, subject_ref, channel, purpose, status);
