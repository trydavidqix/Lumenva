...
describe("Hermes Source Registry RLS", () => {
  beforeAll(async () => {
    ...
    await admin.query(readFileSync("supabase/migrations/20260917100000_0185_hermes_source_registry.sql", "utf8"));
    await admin.query(readFileSync("supabase/migrations/20260917100100_0186_hermes_source_registry_rls.sql", "utf8"));
