...
**Schema:** mudança de banco via migration versionada + apêndice idempotente em `infra/infra/supabase/baseline.sql` + linha no `infra/infra/supabase/migrations/MANIFEST.md`; tipos gerados acompanham quando o contrato muda.
