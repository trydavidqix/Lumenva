...
# sem LUMENVA_GOV_INVARIANTS_EDIT=1.
...
[ "${LUMENVA_GOV_INVARIANTS_EDIT:-0}" = "1" ] && exit 0
...
if [ -n "$violations" ]; then
  ...
  echo "Nesse caso: exporte LUMENVA_GOV_INVARIANTS_EDIT=1 e cite o flip no commit message." >&2
  exit 1
fi
