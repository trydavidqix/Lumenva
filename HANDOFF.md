...
- **Onda:** 5 ✅ COMPLETA. Onda 6 EM ANDAMENTO (UI Builder React Flow): Task 6.1 ✅ + Task 6.2 ✅ + Task 6.3 ✅ (editor de condição de aresta — desbloqueia `ai_classify`/`condition` no builder). Próxima: Onda 7 (UI Fila + seletor no agente).
