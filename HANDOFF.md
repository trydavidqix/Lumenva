...
- **Onda:** 5 ✅ COMPLETA. Onda 6 ✅ COMPLETA (UI Builder React Flow: Task 6.1 + 6.2 + 6.3). Onda 7 EM ANDAMENTO: Task 7.1 ✅ (endpoint fila + aba + cancelar). Próxima: seletor no agente (resto da Onda 7).
