...
export type SearchKnowledgeResult =
  { ok: true; results: KnowledgeHit[] } | { ok: false; error: { code: string; message: string } };
...
export async function searchKnowledge(
  ...
  deps?: { embed?: typeof embedText; log?: Logger; tracer?: AiTracer },
