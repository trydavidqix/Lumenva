  ...
  public: {
    Tables: {
      ...
      agent_errors: {
        ...
        Relationships: [
          {
            foreignKeyName: "agent_errors_agent_id_fkey"
            columns: ["agent_id"]
            isOneToOne: false
            referencedRelation: "ai_agents"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "agent_errors_contact_id_fkey"
            columns: ["contact_id"]
            isOneToOne: false
            referencedRelation: "contacts"
            referencedColumns: ["id"]
      ...
      ai_workflow_runs: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_workflow_runs_contact_id_fkey"
            columns: ["contact_id"]
            isOneToOne: false
            referencedRelation: "contacts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ai_workflow_runs_followup_id_fkey"
            columns: ["followup_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "ai_workflow_runs_lead_id_fkey"
            columns: ["lead_id"]
            isOneToOne: false
            referencedRelation: "crm_leads"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ai_workflow_runs_sent_message_id_fkey"
      ...
      flywheel_followup_outcomes: {
        ...
        Relationships: [
          {
            foreignKeyName: "flywheel_followup_outcomes_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_followup_enrollment_stats: {
        Args: { p_org_id: string }
        Returns: {
          active_enrollments: number
          converted_enrollments: number
          daily_outcomes: Json
          exhausted_enrollments: number
          replied_enrollments: number
          silence_sweep_rate: number
          success_rate: number
