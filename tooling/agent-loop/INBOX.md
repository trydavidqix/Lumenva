...
**Onde vive**: `tooling/agent-loop/inbox.items.md` — não `tooling/agent-loop/inbox.md`, porque em filesystem
case-insensitive (o APFS default do macOS do dono) `tooling/agent-loop/inbox.md` e
`tooling/agent-loop/INBOX.md` são o MESMO arquivo. É um arquivo **operacional, fora do git**
...
## Formato de item (append no fim de `tooling/agent-loop/inbox.items.md`)
