...
| 2 | `HOLD` em `OFF` | [`phase-2-status.md`](../../evidence/ai-platform/phase-2-status.md), [`phase-2-mem0-gate.md`](../../evidence/ai-platform/phase-2-mem0-gate.md) | Tarefas 1–9 e validação Windows do sidecar concluídas; Tarefa 10 parcial — falta comparação Golden Dataset em shadow, que exige chave de provider real. Sem promoção de rollout até isso fechar |
