...
Evidência F0/F1 + M1: `docs/audits/maestri-v3-f0-f1-evidence-2026-09-22.md`. O health probe e a prova read-only real do Codex já passaram. Falta persistir `ExecutionResult`/evidence no runtime e implementar os providers restantes.
