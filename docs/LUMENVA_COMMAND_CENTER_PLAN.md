...
Evidência F0/F1 + M1: `docs/audits/maestri-v3-f0-f1-evidence-2026-09-22.md`. O health probe Codex já é real; falta executar uma task read-only real com o runner e persistir `ExecutionResult`/evidence no runtime.
