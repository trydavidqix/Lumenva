...
| 6 | Studio commercial MVP, ProjectSpec, templates, preview, portal | W1, W2, W5 | `apps/crm/app/`, `apps/website/`, `docs/design-system/` | W7 editor and W9 factory depend on ProjectSpec |
...
| 9 | Product Factory web: architect, generators, Git factory, QA/repair | W2, W6–W8 | `apps/crm/lib/`, `apps/crm/workers/`, `tooling/scripts/`; no canonical `packages/project-generator/` found | W10 requires generated release/deployment contracts |
| 10 | Mobile and production delivery, domains, monitoring, release/rollback, DR | W9, W4 | `ops/`, `infra/docker/`, `docs/runbooks/`, `.github/` | W15 requires production/rollback evidence |
...
| 12 | Governance/security hardening: RBAC/RLS, injection, secrets, fault tests | W1–W11 | `infra/supabase/`, `apps/crm/lib/auth/`, `apps/crm/lib/audit/`, `docs/threat-model.md` | W13 requires security and incident signals |
