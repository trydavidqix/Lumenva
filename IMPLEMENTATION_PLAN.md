...
- PR #74 (`chore/orchestration-gate`): new 18-file governance/hook/evidence implementation opened during parity validation. Its CI checks were still in progress at the last inspection. Keep isolated; assess its own head and behavior before considering integration.
